...
def callback_depth(depth_image):
    global pink1, pink2, yellow1
    bridge = CvBridge()
    img_depth = bridge.imgmsg_to_cv2(depth_image)
    cv2.imwrite('/home/kaai/Datasets/KaAI/a/0000.jpg',img_depth)
    ...
    #yellow2.projection()
    print(pink1.z, pink2.z, yellow1.z)
...
b_color_lower=(100,120,40)
b_color_high=(120,255,255)


y_color_lower = (20, 80, 30)
y_color_high = (30, 255, 255)


pink1 = find_circle(y_color_lower,y_color_high)
# pink2 = find_circle(p_color_lower,p_color_high)
pink2 = find_circle(b_color_lower,b_color_high)
#pink3 = find_circle(color_lower,color_high)
yellow1 = find_circle(p_color_lower,p_color_high)
